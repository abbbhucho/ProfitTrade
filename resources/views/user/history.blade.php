        ...
        <p>The Stock History shows all the details of the particular user:</p>                        
                        ...
                        <table id="history" class="table  table-bordered table-striped table-condensed table-hover">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="col-3" style="width: 16.66%">Gross Total</th>
                                <th scope="col" class="col-1">Extra Charges Applied</th>
                            ...
                            <tr>
                                    ...
                                    <td>{{$stock->buy_price}}</td>
                                        ...
                                        @endif
                                    <td class=col-1 style="width: 16.66%">{{$stock->buy_gross_total}}</td>
